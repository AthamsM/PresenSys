export default function Navbar(props){
  ...
  return (
    ...
    <div className="flex md:hidden justify-between items-center border-b px-2 border-gray-300 font-bold">
      
      <div>
        <button onClick={props.alter} className="hover:bg-gray-200 rounded-md p-1 drop-shadow-md drop-shadow-[#263238]/20">
